...
public class EraserSlamV2 : MonoBehaviour
{
    ...
    [Header("Visuals")] public Vector3 hitOffset;
    ...
    {
        var whiteTrans = new Color(1, 1, 1, 0);
    ...
    {
        var hit = Physics2D.OverlapBoxAll(transform.position + hitOffset, hitSize, 0, playerLayer);
