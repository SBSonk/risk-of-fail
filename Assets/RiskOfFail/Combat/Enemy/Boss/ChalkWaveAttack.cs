...
public class ChalkWaveAttack : BossAttackV2
{
    ...
    [Header("Scaling")] public Vector3 normalScale = new(2, 2, 1);

    public Vector3 attackScale = new(4, 4, 1);
    ...
    [Header("Attack")] public int waves = 4;
    ...
    public override IEnumerator Attack()
    {
        ...
        for (var i = 0; i < waves; i++)
        {
            ...
            var wave = Instantiate(wavePrefab, boss.position + waveOffset, transform.rotation);
