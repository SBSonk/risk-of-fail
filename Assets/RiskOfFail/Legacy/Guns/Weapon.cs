...
public abstract class Weapon : ScriptableObject
{
    ...
    [Header("Weapon Stats")] public float baseDamage;
    ...
    [Header("Weapon Behavior")] public int ammoPerShot;

    public int clipSize = -1; // -1 to disable reloading
    public float reloadLength; // Reload time in seconds   
    public float fireRate = 1f; // Firerate in seconds
    public bool auto; // Determines if you can hold left click
    public ShakeData shootShake, hitScreenShake;

    [Header("Weapon Animations")] public WeaponSFX effects;
