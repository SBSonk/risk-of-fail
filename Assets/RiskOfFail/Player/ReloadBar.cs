...
public class ReloadBar : MonoBehaviour
{
    ...
    [SerializeField] private GameObject reloadParent;
    ...
    private void Start()
    {
        ...
        for (var i = 0; i < sprites.Length; i++) spriteColors[i] = sprites[i].color;
    ...
    private void HideBar(InventoryWeapon _)
    {
    ...
    {
        // Fade in
        for (var i = 0; i < sprites.Length; i++) sprites[i].color = spriteColors[i];
